...
-- inspired by https://medium.com/@jhkuperus/window-management-with-hammerspoon-personal-productivity-c77adc436888
...
screenPositions.center = {x = 1, y = 1, w = HALF_GRID_SIZE, h = HALF_GRID_SIZE }
